    ...
    public class AuthService
    {
        ...
        public LoginResult Login(string username, string password)
        {
            try
            {
                if (string.IsNullOrWhiteSpace(username) || string.IsNullOrWhiteSpace(password))
                {
                    ...
                    {
                        Success = false,
                        Message = "Tên ðãng nh?p và m?t kh?u không ðý?c ð? tr?ng"
                    };
                }
                ...
                if (taiKhoan == null)
                {
                    ...
                    {
                        Success = false,
                        Message = "Tên ðãng nh?p không t?n t?i"
                    };
                }
                ...
                if (taiKhoan.TrangThai == false)
                {
                    ...
                    {
                        Success = false,
                        Message = "Tài kho?n ð? b? khóa. Vui l?ng liên h? qu?n tr? viên"
                    };
                }
        ...
        public RegisterResult Register(RegisterDTO registerInfo)
        {
            try
            {
                ...
                {
                    return new RegisterResult { Success = false, Message = "H? tên không ðý?c ð? tr?ng" };
                }

                if (string.IsNullOrWhiteSpace(registerInfo.TenDN))
                {
                    return new RegisterResult { Success = false, Message = "Tên ðãng nh?p không ðý?c ð? tr?ng" };
                }

                if (string.IsNullOrWhiteSpace(registerInfo.MatKhau))
                {
                    return new RegisterResult { Success = false, Message = "M?t kh?u không ðý?c ð? tr?ng" };
                }
                ...
                {
                    return new RegisterResult { Success = false, Message = "Email không ðý?c ð? tr?ng" };
                }
                ...
                {
                    return new RegisterResult { Success = false, Message = "Tên ðãng nh?p ð? t?n t?i" };
                }
                ...
                {
                    return new RegisterResult { Success = false, Message = "Email ð? ðý?c s? d?ng" };
                }
