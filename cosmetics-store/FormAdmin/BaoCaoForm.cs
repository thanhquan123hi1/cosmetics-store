...
namespace cosmetics_store.Forms
{
    public partial class BaoCaoForm : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void ApplyModernTheme()
        {
            ...
            var lightBlue = Color.FromArgb(100, 150, 220);
            ...
            // Style Labels
            StyleLabel(lblTuNgay, mainFont, textWhite);
            StyleLabel(lblDenNgay, mainFont, textWhite);
            StyleLabel(lblTongDoanhThu, titleFont, Color.FromArgb(255, 200, 100));
            StyleLabel(lblSoDon, boldFont, Color.FromArgb(100, 200, 255));
            StyleLabel(lblSoSPBan, boldFont, Color.FromArgb(150, 255, 150));
            StyleLabel(lblTonKhoThap, boldFont, Color.FromArgb(255, 150, 150));
            ...
            // Style Button
            StyleButton(btnXemBaoCao, Color.FromArgb(0, 123, 255), textWhite, mainFont, "📈 Xem báo cáo");

            // Style TabControl
            tabControl.Font = new Font("Segoe UI", 10F, FontStyle.Bold);

            // Style Grids
            StyleGrid(gridSPBanChay, gridViewSPBanChay);
            StyleGrid(gridTopKH, gridViewTopKH);
            StyleGrid(gridTonKhoThap, gridViewTonKhoThap);
        }
