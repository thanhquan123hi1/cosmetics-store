namespace cosmetics_store.Forms
{
    partial class BanHangForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.grpSanPham.Text = "?? Danh sách s?n ph?m";
            // 
            // searchSanPham
            // 
            ...
            this.btnThemVaoGio.Text = "?? Thêm vào gi?";
            ...
            this.cboPhuongThuc.Properties.Items.AddRange(new object[] { "Ti?n m?t", "Chuy?n kho?n", "Th? tín d?ng" });
